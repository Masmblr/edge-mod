...
static const classAttributes_t bg_classList[ ] =
{
  ...
  },
  {
    ...
    "A support class able to crawl on walls and ceilings. Its melee "
	  ...
	  "It has an Acid Bomb wich can be used as a grenade.",
    ( 1 << S1 )|( 1 << S2 )|( 1 << S3 ),            //int  stages
  ...
  },
  {
    ...
    "level1upg",                                    //char    *classname;
     "In addition to the basic Basilisk abilities, the Advanced"
	  ...
	  "It has an (powerful) Acid Bomb wich can be used as a grenade.",
    ( 1 << S2 )|( 1 << S3 ),                        //int  stages
...
static const weaponAttributes_t bg_weapons[ ] =
{
  ...
  },
  {
    ...
    "[arms]Mass Driver",        //char      *humanName;
  ...
  },
  {
  ...
  },
   {
    ...
    "[arms]Flame Thrower",      //char      *humanName;
  ...
  },
  {
    ...
    "[arms]Pulse Rifle",        //char      *humanName;
  ...
  },
  {
    ...
    "[arms]Lucifer Cannon",     //char      *humanName;
...
{
  {
    ...
    "[hield]Light Armour",         //char  *humanName;
  ...
  },
  {
    ...
    "[hield]Battlesuit",           //char  *humanName;
